            ...
            <div className="bg-white rounded-lg p-6">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 uppercase mb-1">Founded In</p>
                  <p className="font-semibold text-gray-900">{date(data.establishmentYear)}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 uppercase mb-1">Organization Type</p>
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{data.teamSize} Candidates</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 uppercase mb-1">Industry Types</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`https://${data.url}`} className="text-blue-600 hover:underline font-medium">
                      {data.url}
                    </a>
                  </div>
                </div>
