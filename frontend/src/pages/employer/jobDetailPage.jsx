            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              <div className="flex items-start justify-between">
                <div className="flex items-start space-x-4">
                  {/* Company Logo */}
                  <div className={`w-16 h-16 ${job.logoBg} rounded-lg flex items-center justify-center flex-shrink-0`}>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-sm font-medium text-gray-600">Salary (USD)</h3>
                  ...
                  <p className="text-2xl font-bold text-green-600 mb-1">{job.salary}</p>
                ...
                <div className="bg-white rounded-lg p-6">
                  ...
                  <p className="font-semibold text-gray-900 mb-2">{job.location}</p>
