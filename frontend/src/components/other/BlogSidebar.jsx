        ...
        <div className="space-y-4">
          {recentPosts.map((post) => (
            <div key={post.id} className="flex gap-3">
              <img src={post.image} alt="Post" className="w-20 h-16 object-cover rounded-lg flex-shrink-0" />
          ...
          {popularTags.map((tag) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
                tag === "Programming" ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
              }`}
            >
              {tag}
            </button>
